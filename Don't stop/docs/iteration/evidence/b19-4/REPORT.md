...
- Push branch/create PR only when the prescribed implementation work is ready. Squash merge only after required checks and final candidate evidence satisfy the objective; then verify Pages identity and public startup.
