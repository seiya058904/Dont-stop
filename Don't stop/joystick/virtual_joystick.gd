class_name DemoVirtualJoystick
...
func _update_joystick(touch_position: Vector2) -> void:
	...
	if use_input_actions:
		...
		var dir = center.direction_to(_tip.global_position)
		emit_signal("onTouch",dir)

func _update_touch_position():
	_base
