...
const HORDES = {
	...
	23:{"batch":5,"window":4.2,"step":0.32,"floor":7,"windows":2},
	24:{"batch":5,"window":3.9,"step":0.30,"floor":9,"windows":2},
	25:{"batch":6,"window":3.6,"step":0.28,"floor":9,"windows":2},
	26:{"batch":6,"window":3.4,"step":0.28,"floor":10,"windows":2},
	27:{"batch":7,"window":3.1,"step":0.26,"floor":14,"windows":3},
	28:{"batch":8,"window":2.8,"step":0.24,"floor":16,"windows":3},
	29:{"batch":10,"window":2.4,"step":0.22,"floor":18,"windows":3},
...
static func encounters() -> Dictionary:
	return {
		...
		21:{"name":"R5 · 21 双重防线","region":"R5","info":"生存45秒；毒区机制首次登场；多方向分批进入，增援可重叠；敌群 E01 E02 E03 E02 E09 E01 E02 E06 E02 E03","seconds":45,"roles":["E01","E02","E03","E02","E09","E01","E02","E06","E02","E03"],"cap":65,"interval":0.44,"rhythm":"协同","pressure":{"horde_simple":0.60,"ring_min":122.0,"chase_speed":1.06}},
		22:{"name":"R5 · 22 走廊射界","region":"R5","info":"生存45秒；炮击与盾卫封锁走廊；敌群 E01 E02 E09 E02 E10 E01 E02 E11 E02 E09","seconds":45,"roles":["E01","E02","E09","E02","E10","E01","E02","E11","E02","E01"],"cap":55,"interval":0.44,"rhythm":"交替","pressure":{"horde_simple":0.58,"ring_min":122.0,"chase_speed":1.06}},
		23:{"name":"R5 · 23 纵向追猎","region":"R5","info":"生存45秒；冲锋与侧绕沿纵向夹击；敌群 E01 E02 E04 E02 E11 E01 E02 E06 E02 E04","seconds":45,"roles":["E01","E02","E04","E02","E11","E01","E02","E06","E02","E04"],"cap":72,"interval":0.4,"rhythm":"轮换","pressure":{"horde_simple":0.58,"ring_min":122.0,"chase_speed":1.06}},
		24:{"name":"R5 · 24 分裂连锁","region":"R5","info":"生存45秒；母体分裂与载能连爆叠压；敌群 E01 E02 E12 E02 E07 E01 E02 E11 E02 E12","seconds":45,"roles":["E01","E02","E12","E02","E07","E01","E02","E11","E02","E12"],"cap":72,"interval":0.38,"rhythm":"脉冲","pressure":{"horde_simple":0.58,"ring_min":122.0,"chase_speed":1.06}},
		25:{"name":"R5 · 25 能源精英","region":"R5","info":"生存45秒；精英；混合远程 / 治疗 / 自爆 / 重甲；敌群 E01 E02 E03 E02 E05 E01 E02 E08 E02 E06","seconds":45,"roles":["E01","E02","E03","E02","E05","E01","E02","E08","E02","E06"],"cap":68,"interval":0.36,"rhythm":"精英","elite":{"start":22.0,"interval":15.0,"cap":2},"pressure":{"horde_simple":0.56,"ring_min":122.0,"chase_speed":1.06}},
		26:{"name":"R6 · 26 四面清场","region":"R6","info":"生存45秒；能量危险带登场；多方向增援重叠；敌群 E01 E02 E12 E02 E11 E01 E02 E06 E02 E12","seconds":45,"roles":["E01","E02","E12","E02","E11","E01","E02","E06","E02","E12"],"cap":93,"interval":0.34,"rhythm":"轮换","elite":{"start":20.0,"interval":14.0,"cap":2},"pressure":{"horde_simple":0.54,"ring_min":122.0,"chase_speed":1.08}},
		27:{"name":"R6 · 27 核心护卫","region":"R6","info":"生存45秒；高密度追击配精英护卫；敌群 E01 E02 E09 E02 E08 E01 E02 E11 E02 E06","seconds":45,"roles":["E01","E02","E09","E02","E08","E01","E02","E11","E02","E06"],"cap":110,"interval":0.33,"rhythm":"协同","elite":{"start":18.0,"interval":13.0,"cap":2},"pressure":{"horde_simple":0.52,"ring_min":120.0,"chase_speed":1.1}},
		28:{"name":"R6 · 28 交替封路","region":"R6","info":"生存45秒；炮击与盾卫交替封路，能量危险带叠加；敌群 E01 E02 E04 E02 E10 E01 E02 E09 E02 E11","seconds":45,"roles":["E01","E02","E04","E02","E10","E01","E02","E09","E02","E11"],"cap":125,"interval":0.33,"rhythm":"交替","elite":{"start":16.0,"interval":12.0,"cap":3},"pressure":{"horde_simple":0.50,"ring_min":118.0,"chase_speed":1.12}},
		29:{"name":"R6 · 29 平台高潮","region":"R6","info":"生存45秒；三段节奏叠加增援重叠与精英；敌群 E01 E02 E07 E02 E05 E01 E02 E11 E02 E06","seconds":45,"roles":["E01","E02","E07","E02","E05","E01","E02","E11","E02","E06"],"cap":145,"interval":0.32,"rhythm":"三段","elite":{"start":14.0,"interval":11.0,"cap":3},"pressure":{"horde_simple":0.48,"ring_min":116.0,"chase_speed":1.14}},
		...
		# ---- HELL MODE (31-40) ---------------------------------------------------------
		31:{"name":"R7 · 31 雾蚀初现","region":"R7","info":"HELL；生存45秒；战争迷雾开启；低强度毒区；震颤射手与激光哨兵登场；敌群 E01 E02 E14 E02 E13 E01 E02 E15 E02 E13","seconds":45,"roles":["E01","E02","E14","E02","E13","E01","E02","E15","E02","E13"],"cap":52,"interval":0.34,"rhythm":"渐进","hell":true,"flank":true,"elite":{"start":22.0,"interval":15.0,"cap":1},"pressure":{"horde_simple":0.52,"ring_min":120.0,"chase_speed":1.1}},
		32:{"name":"R7 · 32 侧翼包夹","region":"R7","info":"HELL；生存45秒；迷雾下多方向侧翼同时进入；敌群 E01 E02 E13 E02 E11 E01 E02 E14 E02 E15","seconds":45,"roles":["E01","E02","E13","E02","E11","E01","E02","E14","E02","E15"],"cap":56,"interval":0.33,"rhythm":"协同","hell":true,"flank":true,"elite":{"start":21.0,"interval":14.0,"cap":1},"pressure":{"horde_simple":0.50,"ring_min":119.0,"chase_speed":1.1}},
		33:{"name":"R7 · 33 孢子污染","region":"R7","info":"HELL；生存45秒；毒囊与毒区叠加，必须持续移动；敌群 E01 E02 E15 E02 E15 E01 E02 E14 E02 E13","seconds":45,"roles":["E01","E02","E15","E02","E15","E01","E02","E14","E02","E13"],"cap":60,"interval":0.32,"rhythm":"交替","hell":true,"flank":true,"elite":{"start":20.0,"interval":13.0,"cap":2},"pressure":{"horde_simple":0.50,"ring_min":118.0,"chase_speed":1.11}},
		34:{"name":"R7 · 34 精英射线","region":"R7","info":"HELL；生存45秒；精英激光哨兵封锁可见范围；敌群 E01 E02 E14 E02 E14 E01 E02 E13 E02 E15","seconds":45,"roles":["E01","E02","E14","E02","E14","E01","E02","E13","E02","E15"],"cap":64,"interval":0.31,"rhythm":"精英","hell":true,"flank":true,"elite":{"start":19.0,"interval":13.0,"cap":2},"pressure":{"horde_simple":0.48,"ring_min":116.0,"chase_speed":1.12}},
		35:{"name":"R7 · 35 隔离区高压","region":"R7","info":"HELL；生存45秒；R7综合高压：迷雾、毒区、喷发与三方增援；敌群 E01 E02 E14 E02 E13 E01 E02 E15 E02 E11","seconds":45,"roles":["E01","E02","E14","E02","E13","E01","E02","E15","E02","E11"],"cap":68,"interval":0.30,"rhythm":"三段","hell":true,"flank":true,"elite":{"start":18.0,"interval":12.0,"cap":2},"pressure":{"horde_simple":0.46,"ring_min":115.0,"chase_speed":1.12}},
		36:{"name":"R8 · 36 深渊入口","region":"R8","info":"HELL；生存45秒；进入深渊核心，视野进一步收紧；敌群 E01 E02 E14 E02 E12 E01 E02 E13 E02 E15","seconds":45,"roles":["E01","E02","E14","E02","E12","E01","E02","E13","E02","E15"],"cap":72,"interval":0.29,"rhythm":"协同","hell":true,"flank":true,"elite":{"start":17.0,"interval":12.0,"cap":2},"pressure":{"horde_simple":0.46,"ring_min":114.0,"chase_speed":1.13}},
		37:{"name":"R8 · 37 激光网格","region":"R8","info":"HELL；生存45秒；激光网格与哨兵交叉，安全走位变短；敌群 E01 E02 E14 E02 E14 E01 E02 E10 E02 E14","seconds":45,"roles":["E01","E02","E14","E02","E14","E01","E02","E10","E02","E14"],"cap":76,"interval":0.28,"rhythm":"交替","hell":true,"flank":true,"elite":{"start":16.0,"interval":11.0,"cap":3},"pressure":{"horde_simple":0.44,"ring_min":113.0,"chase_speed":1.14}},
		38:{"name":"R8 · 38 裂隙重叠","region":"R8","info":"HELL；生存45秒；危险带与毒区重叠，安全区不断移动；敌群 E01 E02 E15 E02 E13 E01 E02 E14 E02 E12","seconds":45,"roles":["E01","E02","E15","E02","E13","E01","E02","E14","E02","E12"],"cap":80,"interval":0.27,"rhythm":"脉冲","hell":true,"flank":true,"elite":{"start":15.0,"interval":11.0,"cap":3},"pressure":{"horde_simple":0.44,"ring_min":112.0,"chase_speed":1.14}},
