...
const DEFINITIONS = {
	...
	113:{"plan":"W13","name":"蓄能轨道炮","mode":"rail","tags":["beam","energy","charged","straight"],"damage":5.0,"rate":2.0,"magazine":6,"reload":1.8,"speed":100,"range":420.0,"width":14.0,"pierce":7,"charge":0.8,"info":"按住最多蓄力0.8秒，松开发射；蓄力同时加宽束线并增加贯穿。轻点1目标、满蓄最多8目标且伤害×2.5；基础发射后冷却0.5秒。实墙阻断，切枪取消。"},
...
# B14 playtest classification uses moving-horde evidence and real Boss observations.
# No fixed population per tier, no damage multiplier change to force the old GPS order.
# See docs/iteration/playtest-revision.md and the full 24-row review.
const TIERS = {3:1,1:1,0:2,9:1,2:2,5:2,8:1,123:2,7:2,4:3,117:3,118:3,115:4,6:5,111:4,112:5,114:4,116:5,122:4,113:4,119:3,120:4,121:4,124:5}
const PRICES = {"3":90,"1":60,"0":240,"9":120,"2":260,"5":290,"8":150,"123":350,"7":380,"4":840,"117":700,"118":760,"115":1550,"6":2600,"111":1500,"112":3000,"114":1600,"116":3200,"122":1850,"113":1800,"119":920,"120":1750,"121":1850,"124":3600}
