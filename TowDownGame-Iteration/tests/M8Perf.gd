...
func _ready():
	...
	for arg in OS.get_cmdline_user_args():
		if arg in ["normal","late","boss","projectile","telegraph","particle"]: scenario = arg
	...
	var counts = {"normal":12,"late":50,"boss":0,"projectile":150,"telegraph":24,"particle":30}
	...
	print("M8 PERF ",JSON.stringify(row)); LevelServer.return_to_camp(); dismiss(); await wait(0.8)
	...
	print("M8 PERF SUMMARY checks=",checks," failures=",failures)
